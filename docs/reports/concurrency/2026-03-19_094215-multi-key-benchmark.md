...
- Generated At: 2026-03-19 09:47:07
- URI: `http://127.0.0.1:8022/v1/chat/completions`
- Model: `qingyuan`
- Raw JSON: `C:\Users\Administrator\Desktop\人工智能项目\低代码智能体\api调用\docs\reports\concurrency\raw\2026-03-19_094215-multi-key-benchmark.json`

## Summary

| phase | concurrency | total | success | PROCESS_CONCURRENCY_LOCK | 502 | empty_200 | timeout | other | p95_ms |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| staircase | 12 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | - |
| staircase | 16 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | - |
| staircase | 20 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | - |
| steady | 12 | 300 | 300 | 0 | 0 | 0 | 0 | 0 | 2646 |
| steady | 16 | 300 | 300 | 0 | 0 | 0 | 0 | 0 | 2778 |
| steady | 20 | 300 | 300 | 0 | 0 | 0 | 0 | 0 | 2447 |

## Recommendation

- Highest steady-state candidate within budget: `20`
