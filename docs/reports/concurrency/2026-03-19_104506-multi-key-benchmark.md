...
- Generated At: 2026-03-19 10:48:01
- URI: `http://127.0.0.1:8022/v1/chat/completions`
- Model: `qingyuan`
- Raw JSON: `C:\Users\Administrator\Desktop\人工智能项目\低代码智能体\api调用\docs\reports\concurrency\raw\2026-03-19_104506-multi-key-benchmark.json`

## Summary

| phase | concurrency | total | success | PROCESS_CONCURRENCY_LOCK | 502 | empty_200 | timeout | other | p95_ms |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| staircase | 8 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | - |
| steady | 8 | 300 | 0 | 0 | 0 | 300 | 0 | 0 | - |
